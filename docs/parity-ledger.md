...
| Public decoder facade | `decoder.go`, `adts_reader.go` | Go facade | unit tests plus native FAAD2 oracle byte comparison | Exposes explicit raw/ADTS transports, append-style decode APIs, frame metadata, and streaming ADTS reads. |
